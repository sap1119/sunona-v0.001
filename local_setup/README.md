...
2. Sunona server: for creating and handling agents 
...
```bash
docker compose up -d sunona-app twilio-app
# or
docker compose up -d sunona-app plivo-app
```
...
Go to the [sunona examples](https://examples.sunona.dev/) to try out sample agents.
