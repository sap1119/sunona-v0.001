...
from sunona.constants import DEFAULT_LANGUAGE_CODE
from sunona.helpers.utils import convert_to_request_log, compute_function_pre_call_message, now_ms
    ...
    async def generate(self, messages, request_json=False):
        ...
        try:
            ...
            try:
                ...
                if tracker and hasattr(completion, 'usage') and completion.usage:
