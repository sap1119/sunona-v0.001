from .synthesizer import PollySynthesizer, ElevenlabsSynthesizer, OPENAISynthesizer, DeepgramSynthesizer, AzureSynthesizer, CartesiaSynthesizer, SmallestSynthesizer, SarvamSynthesizer, RimeSynthesizer, XttsSynthesizer, SystemSynthesizer
from .transcriber import DeepgramTranscriber, AzureTranscriber , SarvamTranscriber, AssemblyAITranscriber, GoogleTranscriber, WhisperTranscriber
...
if XttsSynthesizer:
    SUPPORTED_SYNTHESIZER_MODELS['xtts'] = XttsSynthesizer
